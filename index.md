...
* [Set 8: Abstract Algebra](#set-8-abstract-algebra)
  * [Challenge 57. Diffie-Hellman Revisited: Small Subgroup Confinement](#challenge-57-diffie-hellman-revisited-small-subgroup-confinement)
  * [Challenge 58. Pollard's Method for Catching Kangaroos](#challenge-58-pollards-method-for-catching-kangaroos)
  * [Challenge 59. Elliptic Curve Diffie-Hellman and Invalid-Curve Attacks](#challenge-59-elliptic-curve-diffie-hellman-and-invalid-curve-attacks)
  * [Challenge 60. Single-Coordinate Ladders and Insecure Twists](#challenge-60-single-coordinate-ladders-and-insecure-twists)
  * [Challenge 61. Duplicate-Signature Key Selection in ECDSA (and RSA)](#challenge-61-duplicate-signature-key-selection-in-ecdsa-and-rsa)
  * [Challenge 62. Key-Recovery Attacks on ECDSA with Biased Nonces](#challenge-62-key-recovery-attacks-on-ecdsa-with-biased-nonces)
  * [Challenge 63. Key-Recovery Attacks on GCM with Repeated Nonces](#challenge-63-key-recovery-attacks-on-gcm-with-repeated-nonces)
  * [Challenge 64. Key-Recovery Attacks on GCM with a Truncated MAC](#challenge-64-key-recovery-attacks-on-gcm-with-a-truncated-mac)
  * [Challenge 65. Truncated-MAC GCM Revisited: Improving the Key-Recovery Attack via Ciphertext Length Extension](#challenge-65-truncated-mac-gcm-revisited-improving-the-key-recovery-attack-via-ciphertext-length-extension)
  * [Challenge 66. Exploiting Implementation Errors in Diffie-Hellman](#challenge-66-exploiting-implementation-errors-in-diffie-hellman)
